...
if (process.argv[3]) {
  ...
  console.log("Ejecuta una tarea indicando su número y argumentos.");
  console.log("Ejemplo: node index.js 1 124");
}

switch (task) {
  case 1:
    globalThis.costCalculator = task1.costCalculator;
    console.log(costCalculator(Number(process.argv[3])));
    break;
  ...
  case 5:
    ...
    console.log(rubricPassFail(Number(process.argv[3])));
    break;

  case 6:
    globalThis.rubricExcellent = task6.rubricExcellent;
    console.log(rubricExcellent(Number(process.argv[3])));
    break;

  case 7:
    globalThis.rubricPerfect = task7.rubricPerfect;
    console.log(rubricPerfect(Number(process.argv[3])));
    break;
}
